...
// (Renumbered: the Bus Organization & Datapath lesson now precedes this as 2.5.)
      ...
      <div style={{ textAlign: "center", padding: 20 }}>
        ...
        <div style={{
          ...
          <div style={{ color: C.muted, fontSize: 13, lineHeight: 1.7 }}>
            You can now run a whole instruction as a control sequence — fetch, decode, then execute — on the datapath you met
            in Unit 2.5.
            <br /><br />
            <strong style={{ color: C.accent }}>Next up: Unit 2.7 — Microprogrammed Control.</strong>{" "}
            The datapath is just idle wires. Who raises the right control signals, in the right order, every single clock?
          </div>
        </div>
      </div>
    );
